<template>
  <div class="movie-info-wrap">
    <header class="movie-info-header">
      ...
      <BIconX class="close-icon" @click="closeTemplate" />
    </header>
        ...
        <BCol cols="4">
          <div class="movie-poster-wrap">
            <div class="movie-poster">
              <b-icon icon="camera" class="camera" font-scale="7.5"></b-icon>
            </div>
          </div>
        </BCol>
        <BCol cols="8">
          <validation-observer ref="observer" v-slot="{ handleSubmit }">
            <BForm @submit.stop.prevent="handleSubmit(onSubmit)">
              ...
              <div class="form-buttom">
                <b-button variant="outline-dark" @click="resetForm"
                  >Reset</b-button
                >
...
export default {
  ...
  methods: {
    ...
    onSubmit() {
      ...
      this.customMovie(this.newFilm);
      this.resetForm();
      this.closeTemplate();
      this.showNotify({
        msg: "Adding custom movie successful",
        variant: "success",
        title: "Success",
      });
    },
